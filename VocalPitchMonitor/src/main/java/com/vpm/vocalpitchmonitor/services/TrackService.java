...
public class TrackService {
    ...
    public void saveVocaltrack(
            @NonNull MultipartFile vocalTrackFile, int songId) throws IOException {

        vocaltrackRepository.save(mapper.toVocaltrack(vocalTrackFile, songId));
    }

    public void saveAudiotrack(
            @NonNull MultipartFile audiotrackFile, int songId) throws IOException {

        audiotrackRepository.save(mapper.toAudiotrack(audiotrackFile, songId));
    }

    public Audiotrack getAudiotrackById(int id) throws EntityNotFoundException{
