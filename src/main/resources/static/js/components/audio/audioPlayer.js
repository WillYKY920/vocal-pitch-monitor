...
export class AudioPlayer {
    constructor(lyricsManager) {
        ...
        // Visualizers
        this.waveformGen = new WaveformGenerator('waveformCanvas');
    ...
    async loadSong(song, artistName) {
        ...
        if (this.currentVocalData) {
            this.pitchMonitor.loadSampleData(this.currentVocalData);
            // ADD: Pass audio element reference for timing
            this.pitchMonitor.setAudioElement(this.audio);
        }
